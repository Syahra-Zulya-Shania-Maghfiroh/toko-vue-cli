    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="staticBackdropLabel">Upload Product Data</h5>
            </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" @click="Upload(id_product)" data-bs-dismiss="modal">Submit</button>
            </div>
        </div>
    </div>
</template>
